...
x <- sensiHSIC(model = NULL, X = X, target =  list(c = 5., upper = TRUE,type = "indicTh", param = 0.5), kernelX = kernelX, kernelY = 'categ', estimator.type = 'V-stat', test.method = "Permutation", B = 1000)
# x <- sensiHSIC(model = NULL, X = X, target =  list(c = 5., upper = TRUE,type = "indicTh", param = 0.5), kernelX = kernelX, kernelY = 'categ', estimator.type = 'V-stat', test.method = "Asymptotic")
# x <- sensiHSIC(model = NULL, X = X, kernelX = kernelX, kernelY = 'rbf',cond = list(c = 5., upper = TRUE,type = "indicTh", param = 0.5), estimator.type = 'V-stat', test.method = "Permutation", B = 1000)
